...
* Your duck is your friend! Check-in quickly and often 🦆
** As a 🦆, be sure to check in with your coder when you feel compelled!
...
|
* PROJ-1234: Added New Apply Button to Jobs Page 👈 Squash all commits into this one on merge
* another
* fix onclick
* adjust height
* add new button
...
For example, here would be a good commit message for two subtasks of a feature:
